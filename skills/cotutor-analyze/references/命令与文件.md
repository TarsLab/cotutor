...
| 文件 | 是什么 |
|---|---|
| `conversations/<老师>/<日期>.json` | 一天的索引:每条消息物化了 text / kidText / section(卡与讲稿)/ tools(读了什么)/ timing / costUsd / post / warnings / holdup / scenes / bookkeeping;顶层 sessions / ratings / booked / costUsd |
