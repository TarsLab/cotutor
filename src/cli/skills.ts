 ...
 * - machine: true 的是机器件(cotutor-board / cotutor-vault / cotutor-analyze / cotutor-tune / cotutor-home:它们和解析器、契约、CLI 要一起变),init / upgrade 每次按包里的覆盖、家长改了也刷,状态只有 latest / upgradable;
...
export { ANALYZE_SKILL, BOARD_SKILL, HOME_SKILL, TUNE_SKILL, VAULT_SKILL };
