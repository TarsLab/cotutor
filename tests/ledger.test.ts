...
const ART = [
  '{"id":"2026-09-08-退位","kind":"课包","by":"math-tutor","at":"2026-09-08T16:30","status":"ready","path":"bundles/x"}',
  '{"id":"2026-09-08-退位","status":"retired","by":"parent","at":"2026-09-08T20:00"}',
...
].join('\n');
{
  ...
  check('折叠后者为准、保留首行字段', m.artifacts.length === 1 && m.artifacts[0].status === 'retired' && m.artifacts[0].path === 'bundles/x' && m.artifacts[0].updatedAt === '2026-09-08T20:05' && m.artifacts[0].by === 'parent');
