...
try {
  ...
  type HMsg = { job: string; handoff?: { to: string } | null; handoffJob?: { tutor: string; job: string } | null; warnings?: string[]; text: string; from: string; runtime?: string; kidText?: string | null };
