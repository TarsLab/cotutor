...
try {
  ...
  check('模板:frontmatter name 一致、带约定', fm.frontmatter.name === 'science-tutor' && fm.frontmatter.memory === undefined && fm.body.includes('科学老师') && fm.body.includes('入口文件') && fm.body.includes('板书') && fm.body.includes('子代理'), fm.body.slice(0, 80));
